...
void setupMockGetIt({
  ...
  // Register mocks, or create new default mocks if not provided
  GetIt.I.registerSingleton<ItemService>(mockItemService ?? MockItemService());
  GetIt.I.registerSingleton<InventoryListService>(mockInventoryListService ?? MockInventoryListService());
  GetIt.I.registerSingleton<ProductService>(mockProductService ?? MockProductService());
}
